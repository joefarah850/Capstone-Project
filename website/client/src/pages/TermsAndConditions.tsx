    ...
    <>
      <div>
        <div className="container-privacy">
          <div>
            <div className="divs-privacy">
              <div className="divs2-privacy">
                <div className="info-privacy">
                  <h1>
                    <strong>Terms and Conditions</strong>
                  </h1>

                  <p>Welcome to TechProp.ai!</p>

                  <p>
                    These terms and conditions outline the rules and regulations
                    for the use of TechProp.ai's Website, located at
                    http://localhost:3000/.
                  </p>

                  <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use TechProp.ai if you do
                  ...
                  <p>
                    ...
                    with and subject to, prevailing law of es. Any use of the
                  ...
                  <p>
                    We employ the use of cookies. By accessing TechProp.ai, you
                    agreed to use cookies in agreement with the TechProp.ai's
                    Privacy Policy.{" "}
                  </p>
                  ...
                  <p>
                    Unless otherwise stated, TechProp.ai and/or its licensors
                    own the intellectual property rights for all material on
                    TechProp.ai. All intellectual property rights are reserved.
                    You may access this from TechProp.ai for your own personal
                  ...
                  <p>You must not:</p>
                  <ul>
                    <li>Republish material from TechProp.ai</li>
                    <li>Sell, rent or sub-license material from TechProp.ai</li>
                    <li>
                      Reproduce, duplicate or copy material from TechProp.ai
                    </li>
                    <li>Redistribute content from TechProp.ai</li>
                  </ul>
                  ...
                  <p>
                    TechProp.ai reserves the right to monitor all Comments and
                  ...
                  <p>
                    You hereby grant TechProp.ai a non-exclusive license to use,
                  ...
                  <p>
                    ...
                    compensates the absence of TechProp.ai; and (d) the link is
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to TechProp.ai. Please
                  ...
                  <p>
                    No use of TechProp.ai's logo or other artwork will be
